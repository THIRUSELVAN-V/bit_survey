...
export const MySurveys = () => {
    ...
    const tabs = [
        { id: "tab1", label: "Live", content: renderSurveyCards(["IncommingSurveyNotStarted","IncommingSurveyStarted"]) },
        { id: "tab5", label: "Completed", content: renderSurveyCards(["IncommingSurveyCompleted"]) },
      ];
  return (
